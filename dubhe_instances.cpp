...
constexpr dubhe_aes_t AES128_PARAMS = {16, 16, 1, 200, 9  /* 160 + 40 */};
constexpr dubhe_aes_t AES192_PARAMS = {24, 16, 2, 416, 10 /* 2*192 + 32 */};
constexpr dubhe_aes_t AES256_PARAMS = {32, 16, 2, 500, 10 /* 2*224 + 52 */};

static const dubhe_instance_t instances[PARAMETER_SET_MAX_INDEX] = {
    {
        {0, 0, 0, 0},
        0,
        0,
...
const dubhe_instance_t &dubhe_instance_get(dubhe_params_t param) {
