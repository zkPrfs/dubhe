...
namespace {
    ...
    void expand_seed(const gsl::span<uint8_t> &seed, const dubhe_salt_t &salt,
    ...
    void expand_seed_x4(const gsl::span<uint8_t> &seed0,
            ...
            const gsl::span<uint8_t> &seed3, const dubhe_salt_t &salt,
            const size_t rep_idx, const size_t node_idx,
...
SeedTree::SeedTree(const std::vector<uint8_t> &seed, const size_t num_leaves,
        const dubhe_salt_t &salt, const size_t rep_idx)
