...
TEST_CASE("Basic Arithmetic in all fields", "[field]") {
  dubhe_params_t params[] = {Banquet_L1_Param1, Banquet_L1_Param3,
                               Banquet_L1_Param4};
  for (auto param : params) {
    field::GF2E::init_extension_field(dubhe_instance_get(param));
    field::GF2E zero;
    field::GF2E one(1);
    field::GF2E x(2);
    field::GF2E x_2(4);
...
TEST_CASE("Modular Arithmetic GF(2^32)", "[field]") {
  field::GF2E::init_extension_field(dubhe_instance_get(Banquet_L1_Param1));
  field::GF2E a, b;
  a.set_coeff(31);
  a.set_coeff(29);
  a.set_coeff(28);
...
TEST_CASE("Modular Arithmetic GF(2^40)", "[field]") {
  field::GF2E::init_extension_field(dubhe_instance_get(Banquet_L1_Param3));
...
TEST_CASE("Modular Arithmetic GF(2^48)", "[field]") {
  field::GF2E::init_extension_field(dubhe_instance_get(Banquet_L1_Param4));
...
TEST_CASE("NTL to_bytes = custom to_bytes", "[field]") {
  field::GF2E::init_extension_field(dubhe_instance_get(Banquet_L1_Param1));
  utils::init_extension_field(dubhe_instance_get(Banquet_L1_Param1));
  field::GF2E a, b;
  a.set_coeff(31);
  a.set_coeff(29);
  a.set_coeff(28);
...
TEST_CASE("NTL to custom conversion", "[field]") {
  dubhe_params_t params[] = {Banquet_L1_Param1, Banquet_L1_Param3,
                               Banquet_L1_Param4};
  for (auto param : params) {
    utils::init_extension_field(dubhe_instance_get(param));
    field::GF2E::init_extension_field(dubhe_instance_get(param));
    field::GF2E a, b;
    a.set_coeff(31);
    a.set_coeff(29);
